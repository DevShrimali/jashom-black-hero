        ...
        <Reveal delay={0.18}>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Magnetic strength={0.18}>
              <a href="https://cal.id/jashom-technologies/30min" target="_blank" rel="noopener noreferrer" className="btn btn-invert-primary">
                Request a Demo
              </a>
            </Magnetic>
            <a href="/portfolio/" className="btn btn-invert-secondary">
              View Case Studies
            </a>
          </div>
        </Reveal>
